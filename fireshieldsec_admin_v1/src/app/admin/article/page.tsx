...
import Banner1 from 'components/admin/nft-marketplace/Banner';
...
const Marketplace = () => {
  ...
  content="Discover the latest NFTs and trends in the market."
  buttonOne={{ title: "Explore Now", link: "/explore" }}
  buttonTwo={{ title: "Learn More", link: "/learn-more" }}
        />
