  ...
  return (
    <div className="mt-3 grid h-full grid-cols-1 gap-5 xl:grid-cols-1 2xl:grid-cols-1">
      <div className="col-span-1 h-fit w-full xl:col-span-1 2xl:col-span-2">
        {/* Bannière */}
        <Banner
          title="Centre de gestion des événements"
          content="Ajouter, modifier, supprimer et gérer l'état des événements à publier"
          buttonOne={{
            title: 'Ajouter un événement',
            link: 'evenement/create',
          }}
          buttonTwo={{
            title: 'Ajouter une catégorie d’événements',
            link: 'evenement/category/',
          }}
        />
            ...
            <Card extra="w-full p-4 h-full">
              <div className="mb-8 w-full">
                ...
                <p className="mt-2 text-base text-gray-600">
                  Ici, vous pouvez trouver plus de détails sur vos catégories d'événements.
                </p>
              </div>
