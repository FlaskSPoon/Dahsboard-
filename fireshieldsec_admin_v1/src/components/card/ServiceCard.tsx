  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col 2xl:items-start 3xl:flex-row 3xl:items-center 3xl:justify-between">
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className="linear mr-2 rounded-[20px] bg-brand-900 px-4 py-2 text-base text-white transition duration-200 hover:bg-brand-800 active:bg-brand-700 dark:bg-brand-400 dark:hover:bg-brand-300 dark:active:opacity-90"
              >
                Afficher
              </button>
              ...
              <button
                ...
                className="linear rounded-[20px] border-[1px] px-2 py-2 text-base text-gray-600 transition duration-200  hover:border-red-500 hover:text-red-500"
              >
                <IoMdTrash />
              </button>
            </div>
      ...
      <ModalContent
        type="danger"
        title={'Suppression'}
        message={`Voulez-vous vraiment supprimer ce service : ${title} ?`}
        onConfirm={() => {}}
