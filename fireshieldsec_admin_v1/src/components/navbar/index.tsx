...
const Navbar = (props: {
  ...
  const { onOpenSidenav, brandText, mini, hovered, secondary } = props;
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        >
          <div className="flex h-48 w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
            ...
            <div className="mt-4 h-px w-full bg-gray-200 dark:bg-white/20 " />
            ...
            <div className="ml-4 mt-4 flex flex-col">
              ...
              <a
                href=" "
                className="mt-4 text-sm text-gray-800 dark:text-white hover:dark:text-white"
              >
                Paramètres du site
              </a>
              <a
